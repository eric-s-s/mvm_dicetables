...
class TestFileHandler(unittest.TestCase):
    ...
    def test_SavedDiceTable_get_x_range(self):
        table = dt.DiceTable()
    ...
    def test_SavedDiceTable_is_empty_true(self):
        data_obj = create_saved_dice_table(dt.DiceTable())
        self.assertTrue(data_obj.is_empty())

    def test_SavedDiceTable_is_empty_false(self):
        table = dt.DiceTable()
        table.add_die(2, dt.Die(2))
        data_obj = create_saved_dice_table(table)
        self.assertFalse(data_obj.is_empty())

    def test_SavedDiceTable_verify_all_types_empty_object(self):
        data_obj = create_saved_dice_table(dt.DiceTable())
        self.assertEqual(data_obj.verify_all_types(), '')

    def test_SavedDiceTable_empty_object_passes_verify_all_types(self):
        self.assertEqual(fh.SavedDiceTable.empty_object().verify_all_types(), '')

    def test_SavedDiceTable_verify_all_types_no_errors(self):
        table = dt.DiceTable()
        table.add_die(1, dt.Die(2))
        data_obj = create_saved_dice_table(table)
        self.assertEqual(data_obj.verify_all_types(), '')
    ...
    def test_SavedDiceTable_verify_all_types_tuple_errors(self):
        ...
        self.assertEqual(data_obj.verify_all_types(), 'error: invalid tuple list')

    def test_SavedDiceTable_verify_all_types_dice_list_errors(self):
        data_obj = create_saved_dice_table(dt.DiceTable())
        data_obj._dice_list = 1
        self.assertEqual(data_obj.verify_all_types(), 'error: invalid dice list')

    def test_SavedDiceTable_verify_all_types_graph_axes_errors(self):
        data_obj = create_saved_dice_table(dt.DiceTable())
    ...
    def test_check_list_or_tuple_for_types_no_error_one_type(self):
        message = fh.check_list_or_tuple_for_types((1., 2., 3.), (float,), 'error')
        self.assertEqual(message, '')

    def test_check_list_or_tuple_for_types_no_error_many_types_data(self):
        message = fh.check_list_or_tuple_for_types((1., 'hi', [1, 2]), (float, list, str), 'error')
        self.assertEqual(message, '')

    def test_check_list_or_tuple_for_types_no_error_many_data_types(self):
        message = fh.check_list_or_tuple_for_types(('a', 'b', 'c'), (float, list, str, tuple), 'error')
        self.assertEqual(message, '')
    ...
    def test_check_list_or_tuple_for_types_with_error_one_type(self):
        message = fh.check_list_or_tuple_for_types((1., 2., 3.), (str,), 'error')
        self.assertEqual(message, 'error')

    def test_check_list_or_tuple_for_types_with_error_many_types(self):
        message = fh.check_list_or_tuple_for_types((1., 2., 'a'), (float, list), 'error')
        self.assertEqual(message, 'error')

    def test_check_list_or_tuple_for_types_edge_case_int_and_long(self):
        message = fh.check_list_or_tuple_for_types((1, 10 ** 1000), (int,), 'error')
        self.assertEqual(message, '')

    def test_check_list_or_tuple_for_types_returns_error_when_not_passed_iterable(self):
    ...
    def test_iterable_and_types_same_len_false(self):
        self.assertFalse(fh.iterable_and_types_same_len([1], [(int,), (str,)]))

    def test_is_list_or_tuple(self):
        self.assertTrue(fh.is_list_or_tuple([]))
        self.assertTrue(fh.is_list_or_tuple((1, 2)))
        self.assertFalse(fh.is_list_or_tuple(1))
        self.assertFalse(fh.is_list_or_tuple(fh.SavedDiceTable.empty_object()))

    def test_check_tuples_in_list_for_types_no_error(self):
        tuple_list = [(1, 2), ('a', 'hi'), (2., 5.)]
        data_types_list = [(int,), (str,), (float,)]
        self.assertEqual('', fh.check_tuples_in_list_for_types(tuple_list, data_types_list, 'error'))
    ...
    def test_check_tuples_in_list_for_types_no_error_multi_types_different_elements(self):
    ...
    def test_check_tuples_in_list_for_types_no_error_empty_list(self):
        empty_list = []
        data_types_list = [(int, float), (str, list), (float,)]
        self.assertEqual('', fh.check_tuples_in_list_for_types(empty_list, data_types_list, 'error'))

    def test_check_tuples_in_list_for_types_one_error(self):
        tuple_list = [(1, 'oops'), ('a', 'hi'), (2., 5.)]
        data_types_list = [(int,), (str,), (float,)]
        self.assertEqual('error', fh.check_tuples_in_list_for_types(tuple_list, data_types_list, 'error'))

    def test_check_tuples_in_list_for_types_multi_errors_one_tuple(self):
    ...
    def test_check_tuples_in_list_for_types_error_when_not_tuple_list(self):
        ...
        self.assertEqual(message, 'error')
        self.assertEqual('error', fh.check_tuples_in_list_for_types(1, [(int,)], 'error'))

    def test_check_tuples_in_list_for_type_sequence_no_error(self):
        tuple_list = [(1, 'a', 2.), (2, 'hi', 5.)]
        data_types_list = [(int,), (str,), (float,)]
        self.assertEqual('', fh.check_tuples_in_list_for_type_sequence(tuple_list, data_types_list, 'error'))

    def test_check_tuples_in_list_for_type_sequence_with_error(self):
        tuple_list = [(1, 'a', 'oops'), (2, 'hi', 5.)]
        data_types_list = [(int,), (str,), (float,)]
        self.assertEqual('error', fh.check_tuples_in_list_for_type_sequence(tuple_list, data_types_list,
                                                                            'error'))

    def test_check_tuples_in_list_for_type_sequence_error_when_not_tuple_list(self):
        message = fh.check_tuples_in_list_for_type_sequence([1, 2], [(int,)], 'error')
        self.assertEqual(message, 'error')
        self.assertEqual('error', fh.check_tuples_in_list_for_type_sequence(1, [(int,)], 'error'))
