...
class Testfh(unittest.TestCase):
    ...
    def test_dice_table_data_equality_test_true(self):
        ...
        table.add_die(2, dt.Die(2))
        data_obj = create_dice_table_data(table)
        not_really_equal_data_obj = fh.DiceTableData('2D2', [(2, 1), (3, 2), (4, 1)], [], [])
    ...
    def test_dice_table_data_empty_object_passes_verify_all_data(self):
        self.assertEqual(fh.DiceTableData.empty_object().verify_all_data(), '')
    ...
    def test_check_data_objects_within_array_returns_first_error(self):
        ...
        self.assertEqual(fh.check_data_objects_within_array(save_data_array), 'error: invalid tuple list')
    def test_check_data_objects_within_array_finds_bad_objects(self):
        obj1 = []
        obj2 = create_dice_table_data(dt.DiceTable())
        save_data_array = np.array([obj1, obj2])
        self.assertEqual(fh.check_data_objects_within_array(save_data_array), 'error: wrong object in array')
    def test_check_data_objects_within_array_no_errors(self):
        obj1 = create_dice_table_data(dt.DiceTable())
        obj2 = create_dice_table_data(dt.DiceTable())
        save_data_array = np.array([obj1, obj2])
        self.assertEqual(fh.check_data_objects_within_array(save_data_array), '')
    def test_check_data_objects_within_array_empty_array(self):
        self.assertEqual(fh.check_data_objects_within_array(np.array([])), '')
